...
const BookingQuerySchema = z.object({
    booking_code: z
        .string({
            required_error: 'Thiếu mã đặt phòng',
            invalid_type_error: 'Thiếu mã đặt phòng',
        })
        .trim()
        .toUpperCase()
...
const WebhookBodySchema = z.record(z.string(), z.any()).refine((data) => Object.keys(data).length > 0, {
